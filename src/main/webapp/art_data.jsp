...
<!DOCTYPE html><html lang="en-US" class=""><head>
  ...
  <div class="elementor-widget-container">
  <div class="header_logo"><a href="https://demo80.leotheme.com/prestashop/leo_postero_elementor_demo/en/"><img class="logo img-fluid" src="images/logo-1694594527.jpg" alt="Leo Postero Elementor"></a></div> </div>
  </div>
  </div>
  </div>
  </div>
  ...
  <div class="elementor-widget-container">
  <a class="ap-btn-wishlist ap-wishlist" href="//demo80.leotheme.com/prestashop/leo_postero_elementor_demo/en/module/leofeature/mywishlist" title="Wishlist" rel="nofollow">
 ...
 <a class="nav-link has-category" href="./contactus_data.jsp" target="_self">
  ...
  <div id="content-wrapper" class="js-content-wrapper left-column col-xs-12 col-sm-12 col-md-8 col-lg-9">
      <table style="margin: 50px auto; border-collapse: collapse; width: 95%; text-align: center; border: 1px solid black;">
<tr>
<td style="border: 1px solid black; padding: 8px;">Art name</td>
<td style="border: 1px solid black; padding: 8px;">Artist Name</td>
...
%>
<tr>
<td style="border: 1px solid black; padding: 8px;"><%=resultSet.getString("artist_name") %></td>
<td style="border: 1px solid black; padding: 8px;"><%=resultSet.getString("aname") %></td>


<td style="border: 1px solid black; padding: 8px;"><%=resultSet.getString("create_date") %></td>

<td style="border: 1px solid black; padding: 8px;"><%=resultSet.getString("description") %></td>
<td style="border: 1px solid black; padding: 8px;"><%=resultSet.getString("price") %></td>
<td style="border: 1px solid black; padding: 8px;"><%=resultSet.getString("image") %></td>

<td style="border: 1px solid black; padding: 8px;"><a href="art_data_dlt.jsp?id=<%= resultSet.getString("id") %>"><button type="button" style="padding: 5px 10px; background-color: #CA9236; color: #fff; border: none;">Delete</button></a></td>
                </tr>
</tr>
<%
i++;
