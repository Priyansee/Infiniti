...
<!DOCTYPE html><html lang="en-US" class=""><head>
    ...
    <ul class="user-info">
    <li>
    <a class="signin leo-quicklogin" data-enable-sociallogin="enable" data-type="popup" data-layout="login" href="artist_register.html" title="Log in to your customer account" rel="nofollow">
    <span>Artist</span>
    </a>
    </li>
    <li>
    <a class="register leo-quicklogin" data-enable-sociallogin="enable" data-type="popup" data-layout="register" href="register.html" title="Log in to your customer account" rel="nofollow">
    <span>Customer</span>
    </a>
    </li>
    </ul>
    ...
    <a class="nav-link  has-category" data-toggle="dropdown" href="./index.html" target="_self">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
        <input  class="form-control" name="email" type="email" placeholder="your@email.com">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="elementor-widget-container">
    <div class="footer_logo"><a href=""><img class="logo img-fluid" src="images/logo-1694594527.jpg" alt="Leo Postero Elementor"></a></div> </div>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="elementor-widget-container">
    <div class="elementor-heading-title elementor-size-default"> <span style="color: #CA9236"></span>
    </div> </div>
    </div>
    </div>
    </div>
