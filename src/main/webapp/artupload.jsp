...
<!DOCTYPE html><html lang="en-US" class=""><head>
    ...
    <ul class="user-info">
    <li>
    <a class="signin leo-quicklogin" data-enable-sociallogin="enable" data-type="popup" data-layout="login" href="artist_login.jsp" title="Log in to your customer account" rel="nofollow">
    <span>Sign in</span>
    </a>
    </li>
    <li>
    <a class="register leo-quicklogin" data-enable-sociallogin="enable" data-type="popup" data-layout="register" href="artist_register.jsp" title="Log in to your customer account" rel="nofollow">
    <span>Register</span>
    </a>
    </li>
    </ul>
    ...
    <a class="nav-link  has-category" data-toggle="dropdown" href="./artist_homepage.jsp" target="_self">
    ...
    <a class="nav-link has-category" href="Art_get.jsp" target="_self">
    <span class="menu-title">My Art</span>
    </a>
    </li>
    <li data-menu-type="cms" class="nav-item   leo-1">
    <a class="nav-link has-category" href="artupload.jsp" target="_self">
    <span class="menu-title">Upload Art</span>
    </a>
    </li>
    <li data-menu-type="cms" class="nav-item   leo-1">
    ...
    <ol>
    <li>
    <a href="./artist_homepage.jsp"><span>Home</span></a>
    </li>
    <li>
    ...
    <h3>Register Your Art</h3>
    <p>Fill all information details.</p>
    </div>
    
    </div>
    <div class="form-group row">
    <label class="col-md-3 form-control-label" for="">Name</label>
    <div class="col-md-9">
    <input  class="form-control" name="pname" type="text" placeholder="Name">
    </div>
    </div>
    <div class="form-group row">
        <label class="col-md-3 form-control-label" for="">Artist Name</label>
        <div class="col-md-9">
        <input  class="form-control" name="aname" type="text" placeholder="Artist">
        </div>
    </div>
    <div class="form-group row">
            <label class="col-md-3 form-control-label" for="">Price</label>
            <div class="col-md-9">
            <input  class="form-control" name="price" type="text" placeholder="">
            </div>
    </div>
    <div class="form-group row">
         <label class="col-md-3 form-control-label" for="number">MRP Price</label>
        <div class="col-md-9">
            <input id="num" class="form-control" name="mprice" type="text" placeholder="">
        </div>
    </div>
    <div class="form-group row">
    <div class="col-md-9">
    ...
    <div class="form-group row">
    <label class="col-md-3 form-control-label" for="">Description</label>
    <div class="col-md-9">
    <textarea class="form-control" name="description" placeholder="Write Art Description Here" rows="3"></textarea>
    </div>
    </div>
    <div class="form-group row">
      <label class="col-md-3 form-control-label" for="">Product Category</label>
      <div class="col-md-9">
    ...
    <div class="form-group row">
    <label class="col-md-3 form-control-label" for="">Status</label>
    <div class="col-md-9">
    <select name="status" id="id_contact" class="form-control form-control-select">
    ...
    <div class="form-group row">
        <label class="col-md-3 form-control-label" for="">Attachment</label>
        <div class="col-md-9">
    ...
    <div class="elementor-widget-container">
    <div class="elementor-heading-title elementor-size-default"><span style="color: #CA9236"></span></div> </div>
    </div>
    </div>
    </div>
    </div>
