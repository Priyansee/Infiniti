...
<!DOCTYPE html><html lang="en-US" class=""><head>
  ...
  <div class="elementor-widget-container">
  <div class="header_logo"><a href=""><img class="logo img-fluid" src="images/logo-1694594527.jpg" alt="Leo Postero Elementor"></a></div> </div>
  </div>
  </div>
  </div>
  </div>
 ...
 <a class="nav-link has-category" href="./contactus_data.jsp" target="_self">
  ...
  <div id="content-wrapper" class="js-content-wrapper left-column col-xs-12 col-sm-12 col-md-8 col-lg-9">
     <table class="table table-striped table-bordered table-hover" style="width: 95%;">
        ...
        <tbody>
            <%
                ResultSet resultOrders = DBconnection.getResultFromSqlQuery("select * from tblorders");
            ...
            <tr>
                ...
                <td>
                    <img src="upload/<%=resultOrders.getString(9)%>" alt="" class="pro-image-front" style="width: 150px; height: 100px;"><br>
                ...
                <%
                    if (resultOrders.getString(15).equals("Deliver")) {
                %>
                <td><a href="OrderStatus?orderId=<%=resultOrders.getInt(2)%>"><button class="btn btn-primary" onClick="return confirm('Are you sure, You want to change product delivery status');">Pending</button></a></td>
                <%
                    } else {
                %>
                <td><a href="OrderStatus?orderId=<%=resultOrders.getInt(2)%>"><button class="btn btn-primary" onClick="return confirm('Are you sure, You want to change product delivery status?');">Deliver</button></a></td>
                <!--Order no is used to identify the line -->
                <%
                    }
                %>
            </tr>
