...
<!DOCTYPE html><html lang="en-US" class=""><head>
  ...
  <div class="elementor-widget-container">
  <div class="header_logo"><a href="Admin_homepage.jsp"><img class="logo img-fluid" src="images/logo-1694594527.jpg" alt="Leo Postero Elementor"></a></div> </div>
  </div>
  </div>
  </div>
  </div>
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <%
                                            ResultSet resultOrders = DBconnection.getResultFromSqlQuery("select * from tblorders where order_status='Deliver'");
