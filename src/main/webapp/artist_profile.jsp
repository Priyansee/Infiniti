...
<!DOCTYPE html><html lang="en-US" class=""><head>
  ...
  <li>
  <a class="register leo-quicklogin" data-enable-sociallogin="enable" data-type="popup" data-layout="register" href="artist_register.html" title="Log in to your customer account" rel="nofollow">
  <span>Register</span>
  </a>
  </li>
  </ul>
  ...
  <a class="nav-link  has-category" data-toggle="dropdown" href="Art_get.jsp" target="_self">
...
String sql ="select * from artist_reg where email='"+ session.getAttribute("artt")+"'";
...
%>
  ...
  <form action="artist_update_profile.jsp" >
  ...
  <div class="col-md-6">
  <input id="id" class="form-control" name="id" type="text" value="<%=resultSet.getString("id") %>" >
  </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
      ...
      <div class="col-md-6">
          <input id="num" class="form-control" name="number" type="text" value="<%=resultSet.getString("number") %>" >
      </div>
  </div>
  <div class="form-group row">
  <div class="col-md-6">
  ...
  <input class="btn btn-primary" type="submit" name="submitMessage" value="Save Changes">
  </footer>
  </form>
  <div class="form-group row">
  <div class="offset-md-3">
  ...
  <input type="text" name="url" value="">
  <input type="hidden" name="token" >
  <a href="delete.jsp?id=<%=resultSet.getString("id") %>"><input class="btn btn-primary" type="submit" name="submitMessage" value="Delete Profile">
  </footer>
    <%
}
connection.close();
