<!DOCTYPE html><html lang="en-US" class=""><head>
    ...
    <div class="form-group row">
        <label class="col-md-3 form-control-label" for="email">User Name</label>
        <div class="col-md-6">
    ...
    <ul class="list-items vertical">
    <li class="list-item vertical">
    <a class="item-text" href="about.html">
    About Us
    </a>
    </li>
    <li class="list-item vertical">
    ...
    <div class="elementor-widget-container">
    <div class="footer_logo"><a href="./index.html"><img class="logo img-fluid" src="images/logo-1694594527.jpg" alt="Leo Postero Elementor"></a></div> </div>
    </div>
    </div>
    </div>
    </div>
